...
RUN apt-get update && apt-get install -y libpng12-dev libjpeg-dev wget php5-cli php5-mysql mysql-client git-core && rm -rf /var/lib/apt/lists/* \
...
CMD ["wp", "--allow-root", "--port=80", "--host=0.0.0.0", "server"]
